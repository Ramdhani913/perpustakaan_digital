        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">
                    Masukkan informasi detail akun pengguna di bawah ini.
                </p>
                ...
                <form action="{{ route('users.store') }}" method="post" enctype="multipart/form-data" class="forms-sample">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email" placeholder="email@contoh.com" value="{{ old('email') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="08xxxx" value="{{ old('no_hp') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary mr-2">Simpan User</button>
